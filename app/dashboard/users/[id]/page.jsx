...
const SingleUserPage = async({ params }) => {
  ...
  return (
    <div className={singleUserStyles.container}>
      <div className={singleUserStyles.infoContainer}>
        <div className={singleUserStyles.imgContainer}>
          <Image src="/noavatar.png" fill alt="" />
        </div>
        {user.username}
      </div>
      <div className={singleUserStyles.formContainer}>
        <form action={updateUser} className={singleUserStyles.form}>
